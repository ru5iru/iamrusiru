...
const post: BlogPost = {
  ...
  seoKeywords: [
    "developer journal",
    "why developers should keep a journal",
    "engineering journal",
    "programmer journaling",
    "journaling for productivity",
    "learning log developer",
    "reflective practice software engineering",
    "knowledge management for developers",
    "developer brag document",
    "daily engineering notes",
    "journaling for performance reviews",
  ],
  content: [
